...
# ree/v1.2.0/schema/objects/transactions/retraction/EquityCompensationRetraction.s
# chema.json
...
class EquityCompensationRetraction(
    Object, Transaction, SecurityTransaction, Retraction
):
    """Object describing a retraction of equity compensation"""

    object_type: Annotated[
        Literal["TX_EQUITY_COMPENSATION_RETRACTION"],
        Field(
            description="This is done to avoid a breaking change as we work towards a bigger restructure"
            "of the equity types in v2.0.0. `TX_PLAN_SECURITY_RETRACTION` will be deprecated"
            "in v2.0.0"
        ),
