...
# ree/v1.2.0/schema/objects/transactions/exercise/EquityCompensationExercise.schem
# a.json
...
class EquityCompensationExercise(Object, Transaction, SecurityTransaction, Exercise):
    """Object describing equity compensation exercise transaction"""

    object_type: Annotated[
        Literal["TX_EQUITY_COMPENSATION_EXERCISE"],
        Field(
            description="This is done to avoid a breaking change as we work towards a bigger restructure"
            "of the equity types in v2.0.0. `TX_PLAN_SECURITY_EXERCISE` will be deprecated in"
            "v2.0.0"
        ),
